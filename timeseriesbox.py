...
# 1, 2, 4, 8 workers
file_list_5m = [r'D:\exp_data\1561526317_1w\swarm_ea_1561526317.csv', 
...
def plot_row(row, box_dimensions):
...
plot_row(0, get_box_dimensions(file_list_5m))
plot_row(1, get_box_dimensions(file_list_10m))
